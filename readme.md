...
curl -i -X POST -d "grant_type=client_credentials&client_id=uraXRboY9ijqHWjO&client_secret=hGD49fqKswpQbPpIFrUrEXsONlp06cdv&scope=content.read" http://newapi.formandsystem.local/oauth/access_token
