...
class BasicRequest extends Request{
	...
	public function authorize(Authorizer $authorizer, UserRepository $userRepository)
	{
		...
		$db = array(
			...
			// 'port' 	    => '8367',
			//'options' => [
				//\PDO::MYSQL_ATTR_SSL_CA => __DIR__.'/../../../certificates/www.copra-system.de.crt',
				// PDO::MYSQL_ATTR_SSL_CERT    => __DIR__.'/../../../certificates/www.copra-system.de.crt',
	            // PDO::MYSQL_ATTR_SSL_CA    => __DIR__.'/../../../certificates/ca-chain.crt',
			//]
		);
